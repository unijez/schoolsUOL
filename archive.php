	...
	<div class="module-inner-wrap">
		 			...
		 			<div class="post-head post-archive">
		 					...
		 					<h4 class="post-title">
		 							...
		 							elseif ( is_category() ) :
		 								printf( __( 'Category: %s', 'schoolsUOL' ), single_cat_title( '', false ) . '' );
		 			
		 							elseif ( is_tag() ) :
		 								printf( __( 'Tag: %s', 'schoolsUOL' ), single_tag_title( '', false ) . '' );
		 			
		 							elseif ( is_author() ) :
		 								$curauth = ( isset( $_GET['author_name'] ) ) ? get_user_by( 'slug', $author_name ) : get_userdata( intval( $author ) );
		 								printf( __( 'Author: %s', 'schoolsUOL' ), $curauth->display_name );
